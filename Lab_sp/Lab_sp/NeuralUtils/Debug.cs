...
namespace Recognition.NeuralUtils
{
    public static class Debug
    {
        ...
        [Conditional("DEBUG")]
        public static void AssertEqualVectorSize<T>(T[] vector, int height, int width)
        {
            AssertNotNull(vector);
            if (vector.Length != height * width) throw new ArgumentException("length");
        }
